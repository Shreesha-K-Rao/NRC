...
class StartPage(tk.Frame):
    ...
    def __init__(self,parent,controller):
        ...
        def register():
            ...
            window.mainloop()
        ls_btn=tk.Button(LeftFrame,text="Register",font=('bahnschrift',15),command=register,fg="#000000",bg='white',padx=1)
...
class Homepage(tk.Frame):
    ...
    def __init__(self,parent,controller):
        ...
        cr3_btn=tk.Button(b_frame,text="View Cancelled Flights",font=('bahnschrift',15),bg='#1a1a1a',fg='black',command=lambda: controller.show_frame(cancelledpage),relief='raised',borderwidth=2,width=50,height=5)
...
class cancelledpage(tk.Frame):
    ...
    def __init__(self,parent,controller):
        ...
        scrollbar= tk.Scrollbar(RightFrame)
        scrollbar.grid(row=0, column=1,sticky='ns')
        BottomFrame2=tk.Frame(self,bd=1,relief='ridge',bg="white")
